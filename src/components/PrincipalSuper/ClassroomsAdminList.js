...
import SupportText from '../../constants/FAQ';
  ...
  /* TODO: 
  ClassroomsAdminList
  To get the array of teacher summaries from redux you call the selector 
  'getSchoolTeacherSummaries' in 'principalSuperintendentSelectors' and 
  you pass in the name of the school which is the key to the object in redux.  
  Selecting a classroom takes you to TeacherAdminView
  */
