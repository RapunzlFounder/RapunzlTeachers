...
import SupportText from '../../constants/FAQ';
  ...
  /* TODO: 
  TeacherAdminView
  Call the action 'getTeacherClassroom' in 'classroomActions' and pass in the classroomId. 
  This returns the object but does not store it in redux, and should return a large summary
