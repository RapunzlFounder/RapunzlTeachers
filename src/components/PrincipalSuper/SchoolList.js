...
import SupportText from '../../constants/FAQ';
  ...
  /* TODO: 
  SchoolList is for supers only and an intermediary step to view ClassroomAdminList which is Principal view from the menu
  To get the array of all schools and teacher summaries from redux you call the selector 'getAllSchoolTeacherSummaries' in 'principalSuperintendentSelectors'. 
  Selecting a school takes you to classroom admin 
  */
